...
@section('content')
<div id="contentPembimbing2">
    <div class="flex justify-between mb-4">
        <input type="text" placeholder="Cari..." class="text-xl border px-2 py-1 rounded w-1/3">
        <button onclick="showModal('tambah-pembimbing2')" class="text-xl flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-2 py-2 rounded cursor-pointer">
...
<div id="modal-tambah-pembimbing2" class="hidden fixed inset-0 flex items-center justify-center z-50">
    <div class="bg-white w-1/3 p-5 border-2 rounded-lg shadow-lg relative">
        <h2 class="text-xl font-medium underline mb-1">Tambah Data Pembimbing Kampus</h2>
        <button
        ...
        <div class="p-4">
            <form>
                <div class="mb-2">
                    <label class="block text-xl font-medium text-gray-700 mb-1">NIDN</label>
...
<div id="modal-edit-pembimbing2" class="hidden fixed inset-0 flex items-center justify-center">
    <div class="bg-white w-1/3 p-5 rounded-lg border-2 shadow-lg relative">
        <h2 class="text-xl font-bold underline mb-4">Edit Data Pembimbing Kampus</h2>
        <div class="p-4">
            <form>
                <div class="mb-4">
                    <label class="block text-xl font-medium text-gray-700 mb-1">NIDN</label>
...
<div id="modal-hapus-pembimbing2" class="hidden fixed inset-0  flex items-center justify-center z-50">
    <div class="bg-white w-1/3 p-5 border-2 rounded-lg shadow-lg relative">
        <h2 class="text-xl font-bold mb-4 text-center underline">Hapus Pembimbing Kampus</h2>
        <p class="text-xl text-center mb-6">Apakah Anda yakin ingin menghapus Pembimbing Kampus ini?</p>
